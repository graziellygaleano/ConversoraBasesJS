...
// }
    ...
    const {numero, nBinario, historico } = decPbin(dec)
    ...
    for (const decimal in historico) {
        const binario = historico[decimal]
        // em js o for em um dic não pega indexes, ele pega as chaves msm, por isso "const" ele está passando por valores reais, que não pretendemos mudar



        historicoFinal += `Decimal: ${decimal} Binário: ${binario}\n`
